...
public class BuyStepdefs {
    ...
    @When("I buy {string} with quantity {int} more than stock")
    public void i_buy_with_quantity_more_than_stock(String name, int quantity) throws NotEnoughStockException {
